...
router.put('/channel_creator/:channel', (request, response) => {
...
router.put('/channel_task/:channel', (request, response) => {
    const channel = request.params.channel;
...
router.put('/channel_user_subscribe/:channel', (request, response) => {
    const channel = request.params.channel;
...
router.put('/task_info/:task&:channel', (request, response) => {
...
router.put('/user_channel_point/:user&:channel', (request, response) => {
...
router.put('/user_task_info/:user&:channel&:task', (request, response) => {
    const user = request.params.user;
    const channel = request.params.channel;
    const task = request.params.task;
